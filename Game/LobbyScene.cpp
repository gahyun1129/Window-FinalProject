...
void LobbyScene::ProcessKey(UINT iMessage, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
	{
		if (wParam == VK_1 && !isScorePrint) {
			Scene* scene = Framework.CurScene;   // 현재 씬을 tmp에 넣고 지워줌
			delete scene;
		}
		//else if (wParam == VK_2 && !isScorePrint) {
		//	Scene* scene = Framework.CurScene;   // 현재 씬을 tmp에 넣고 지워줌
		...
		//	delete scene;
		//}
		//else if (wParam == VK_3 && !isScorePrint) {
		//	Scene* scene = Framework.CurScene;   // 현재 씬을 tmp에 넣고 지워줌
		...
		//	delete scene;
		//}
		//else if (wParam == VK_4 && !isScorePrint) {
		//	Scene* scene = Framework.CurScene;   // 현재 씬을 tmp에 넣고 지워줌
